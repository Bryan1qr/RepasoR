...
head(dataMejora,20)
# pasamos de tabla larga a matriz de contingencia
table(dataMejora)
```
...
with(dataMejora, chisq.test(treatment, improvement,
                            correct = FALSE))
# son dependientes
...
La correccione de yates se hace cuando los valores esperados son menores a 5
...
# gráfico doubledecker
vcd::doubledecker(Grados~Nivel,data=gradosLarga)

# Sombreado por su nivel de aporte
